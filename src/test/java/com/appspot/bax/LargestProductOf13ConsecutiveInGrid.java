 ...
 */
public class LargestProductOf13ConsecutiveInGrid {


    public LargestProductOf13ConsecutiveInGrid() {
    }
    ...
    private void compute() {
        ...
        for (int i = 0; i < size - 13; i++) {
            String[] numbers = input.substring(i, i + 13).split("");
            long prod = 1;
            ...
            if (prod > maxProd) {
                maxProd = prod;
                maxString = input.substring(i, i + 13);
            }
        }
